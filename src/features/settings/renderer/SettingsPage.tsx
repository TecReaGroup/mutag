...
export function SettingsPage({ language, onLanguageChange, defaultKeys, onDefaultKeysChange, models, activeModel, onModelsChange, disabled, onBack, t }: SettingsPageProps) {
  const [category, setCategory] = useState("audio-tag");
  const categories = [{ key: "audio-tag", label: t("Audio Tag", "音频标签") }, { key: "openai", label: "LLM" }, { key: "language", label: t("Language", "语言") }];
